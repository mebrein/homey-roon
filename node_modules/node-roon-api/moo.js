...
Moo.prototype.handle_response = function(msg, body) {
  if (this.requests[msg.request_id] !== undefined){
    if ('cb' in this.requests[msg.request_id]){
      let cb = this.requests[msg.request_id].cb;
      if (cb) cb(msg, body);
    }
    else {
      console.log('EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEKS - no cb')
    }
  }
  else {
    console.log('EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEKS - no requests with the message id')
  }
